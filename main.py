...
if selected_tab == "Dataframes":
    ...
    st.write("This section displays the forecasted stock price data for {} for our Project 1  {} Final Project {}.".format(selected_stock, end_date, end_date + pd.Timedelta(days=period)))
